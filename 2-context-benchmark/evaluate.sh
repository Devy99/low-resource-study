...
echo "Model name: $MODEL_NAME, Benchmark dataset: $BENCHMARK_DATASET, Language: $LANGUAGE, Temperature: $TEMPERATURE, Batch size: $BATCH_SIZE, Completion limit: $COMPLETION_LIMIT, Max tokens: $MAX_TOKENS, Prompt prefix: $PROMPT_PREFIX, Label: $LABEL"
