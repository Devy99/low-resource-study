...
MODEL_BASE_PATH="../3-pretrain-finetune/checkpoints/${MODEL_LABEL}/finetuning/${LANGUAGE_FULL}_finetuning"
...
MAX_TOKENS=1024
PROMPT_PREFIX=""
LABEL="no_context_finetuned"

RESULTS_DIR="./results_finetuned/$MODEL_LABEL"
mkdir -p $RESULTS_DIR
